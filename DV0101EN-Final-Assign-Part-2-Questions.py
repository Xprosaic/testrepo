...
def update_input_container(select_year, input_year):
    if select_year =='Yearly Statistics': 
        return False
    else: 
        return True
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        R_chart4 = dcc.Graph(figure=px.bar(Recession,
        x='Vehicle_Type',
        y='Automobile_Sales',
       #color='.............',
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        mas=data.groupby('Vehicle_Type')['Automobile_Sales'] 
  ...
  # Plot bar chart for average number of vehicles sold during the given year
         # grouping data for plotting.
         # Hint:Use the columns Year and Automobile_Sales
        avr_vdata=yearly_data.groupby('Year')['Automobile_Sales']
        Y_chart3 = dcc.Graph( 
            figure=px.bar(yearly_rec,
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Average number of vehicles sold by vehicle type in the year {}'.format(input_year)))
